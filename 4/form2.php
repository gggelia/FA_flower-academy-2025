 ...
 <main>
        <section class="course-content" >
            ...
            <ul class="checkmark-list">
                ...
                <li>Техники сборки букетов</li>
                <li>Работу с разными видами упаковки и аксессуарами</li>
                <li>Методы сохранения свежести срезанных цветов и продления жизни букетов</li>
                <li>Принципы создания свадебных, юбилейных и корпоративных букетов</li>
                <li>Основы фитодизайна и оформления интерьеров цветами</li>
                <li>Биологическую совместимость цветов</li>
            </ul>
        ...
        <section class="instructor" style="text-align: center;">
            ...
            <div class="instructor-info">
                <img src="../img/flor2.png" alt="Фото преподавателя">
                <h3>Александр Петров</h3>
                <p>Дизайнер букетов</p>
            </div>
            <div class="instructor-info">
                <img src="../img/flor1.png" alt="Фото преподавателя">
                <h3>Мария Иванова</h3>
                <p>Преподаватель флористики</p>
            </div>
            <div class="instructor-info">
                <img src="../img/flor5.png" alt="Фото преподавателя">
